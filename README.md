...
## Overview of Pre-work Steps _(time to complete per item)_
...
### Complete the setup guide for your computer's operating system _(multiple downloads are involved; 1-3 hours depending on your network speed)_
...
- [Codecademy.com, Intro to HTML](https://www.codecademy.com/learn/learn-html)

- [Codecademy.com, Intro to CSS](https://www.codecademy.com/learn/learn-css)
...
If you finish the above and have VS Code installed, try going through these tutorials using the VS Code Editor with the [Live Server extension](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer). If you do not have a VS Code environment working you can also use a [Javascript Environment hosted on Repl.it](https://repl.it/repls/StandardVirtualConfig):
