# Preparing For Success: Prep-Work

## Why is this prep work important?

#### Success Indicators and Outcomes

**We ask that all students take this preparation work seriously, regardless of prior education or code exposure.** 
While most students adjust to the pace and intensity of the program over the first week or two, some students find that the adjustment period can create a cycle of incomplete work, struggle, and demoralizing outcomes that takes much longer to break.
...
**The purpose of this prep work is to give you exposure and familiarity, _not_ comprehension or competency.** 
It is likely that you'll have way more questions than answers. The material may go over your head, things may still not make sense, and you probably haven't gained the ability to execute the material on your own. That's ok!  
...
work gives enrolled students a clear, step-by-step guide for what they need to achieve **before they start classes**. We understand that some things will still be confusing and may not make sense. That's ok! 
...
**On successful completion of the `Computer Setup Guide` you should be able to:**
1. Have a terminal with a Git-compatible prompt.
1. Type `git --version` in your terminal and not receive an error.
1. Be able to open VSCode from the Terminal or Git Bash by typing `code .`. 
1. Have a GitHub account on Github.com (please select a professional username, employers will be looking at it!).
...
Read: **[1. The Command Line](https://ryanstutorials.net/linuxtutorial/commandline.php)**  | 10-15 minutes |
Read: **[2. System Navigation](https://ryanstutorials.net/linuxtutorial/navigation.php)**  | 10-15 minutes |
Read: **[3. Files](https://ryanstutorials.net/linuxtutorial/aboutfiles.php)**  | 15-20 minutes |
Read: **[4. File Manipulation](https://ryanstutorials.net/linuxtutorial/filemanipulation.php)**  | 15 -20 minutes |
...
Essentials | Time To Complete 
|---|---|
Section 1.a: **[Intro To JavaScript](https://www.codecademy.com/courses/introduction-to-javascript/lessons/introduction-to-javascript/exercises/intro)** | 1-2 hours |
Section 1.b: **[Variables](https://www.codecademy.com/courses/introduction-to-javascript/lessons/variables/exercises/intro-variables)** | 1-2 hours |
Section 2: **[Conditional Statements](https://www.codecademy.com/courses/introduction-to-javascript/lessons/control-flow/exercises/control-flow-intro)** | 1-2 hours |
Section 3: **[Functions](https://www.codecademy.com/courses/introduction-to-javascript/lessons/functions/exercises/intro-to-functions)** | 1-2 hours |
Section 4: **[Scope](https://www.codecademy.com/courses/introduction-to-javascript/lessons/scope/exercises/scope)** | 1-2 hours |
...
Essentials | Time To Complete 
|---|---|
Section 1.a: **[Intro To HTML](https://www.codecademy.com/courses/learn-html/lessons/intro-to-html/exercises/intro)** | 1-2 hours |
Section 1.b: **[HTML Document Standards](https://www.codecademy.com/courses/learn-html/lessons/html-document-standards/exercises/prepare-html)** | 1-2 hours |
Section 4: **[Semantic HTML](https://www.codecademy.com/courses/learn-html/lessons/semantic-html)** | 1-2 hours |

## CSS 

Essentials | Time To Complete 
|---|---|
Section 1.a: **[Intro to CSS](https://www.codecademy.com/courses/learn-css/lessons/css-setup-selectors/exercises/intro-to-css)** | 1-2 hours | 
Section 1.b: **[Visual Rules](https://www.codecademy.com/courses/learn-css/lessons/css-visual-rules/exercises/css-visual-rules)** | 1-2 hours |
Section 2.a: **[The Box Model](https://www.codecademy.com/courses/learn-css/lessons/box-model-intro/exercises/box-model-intro)** | 1-2 hours |
Section 2.b: **[Changing the Box Model](https://www.codecademy.com/courses/learn-css/lessons/box-model-new/exercises/change-model)** | 1-2 hours |
Section 3: **[Display and Positioning](https://www.codecademy.com/courses/learn-css/lessons/css-display-positioning/exercises/html-flow)** | 1-2 hours |
Section 4: **[Color](https://www.codecademy.com/courses/learn-css/lessons/color)** | 1 hour |
Section 5: **[Typography](https://www.codecademy.com/courses/learn-css/lessons/css-typography/exercises/typography)** | 1-2 hours |


---

## Textbooks and Preliminary Reading
...
More | Info
|---|---|
Watch: **[The Coding Train: GitHub](https://www.youtube.com/watch?v=BCQHnlnPusY&list=PLRqwX-V7Uu6ZF9C0YMKuns9sLDzK6zoiV&index=1)** | This video goes over the concepts of commits and repositories, as well as an overview of the GitHub User Interface. |
Watch: **[The Coding Train: Git & Intro to the Command Line](https://www.youtube.com/watch?v=oK8EvVeVltE&list=PLRqwX-V7Uu6ZF9C0YMKuns9sLDzK6zoiV&t=203s)** | This video aims to give you a brief introduction to the Command Line and show you some of the most frequently used commands. |
Sections 1-3: **[Learn Git Branching](https://learngitbranching.js.org)** | `Introduction to Git Commits`, `Branching in Git`, and `Merging in Git` |
...
Complete: **[Intro to JavaScript: Drawing and Animation](https://www.khanacademy.org/computing/computer-programming/programming)** |

## HTML 

More | Info
|---|---|
(HTML) Read: **[HTML Tutorial](https://ryanstutorials.net/html-tutorial/)** | |
(HTML) Watch: **[Scrimba Video Tutorial by Eric Tirado](https://scrimba.com/course/ghtml)** | |
(HTML & CSS) Complete: **[Intro to HTML/CSS: Making webpages](https://www.khanacademy.org/computing/computer-programming/html-css)** | Complete up through and including the _Web development tools_ section | 

## CSS

More 
---|
Section 6.a: **[Grid](https://www.codecademy.com/courses/learn-css/lessons/css-grid-i/exercises/grid-intro)** |
Section 6.b: **[Advanced Grid](https://www.codecademy.com/courses/learn-css/lessons/css-grid-ii/exercises/introduction-css-grid-ii)** |
(CSS) Read: **[CSS Tutorial](https://ryanstutorials.net/css-tutorial/)** | 
(CSS) Watch: **[Scrimba Video Tutorial By Eric Tirado](https://scrimba.com/course/gintrotocss)** |
...
If you do _not_ have a VS Code environment working you can also use a [JavaScript Environment hosted on Repl.it](https://repl.it/repls/StandardVirtualConfig).
